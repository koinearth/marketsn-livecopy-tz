                    ...
                    "args": [
                      ...
                      },
                      {
                        ...
                        "args": [
                          ...
                          { "prim": "pair", "args": [ { "prim": "address", "annots": [ "%oracleContract" ] }, { "prim": "string", "annots": [ "%tokenSymbol" ] } ] }
                        ]
                      }
                    ],
                    "annots": [ "%mint" ]
                  ...
                  "args": [
                    {
                      "prim": "pair",
                      "args": [
                        { "prim": "pair", "args": [ { "prim": "key" }, { "prim": "pair", "args": [ { "prim": "address" }, { "prim": "nat" } ] } ] },
                        {
                          "prim": "pair",
                          "args": [
                          ...
                          "args": [
                            {
                              "prim": "pair",
                              "args": [
                                { "prim": "big_map", "args": [ { "prim": "bytes" }, { "prim": "nat" } ] },
                                {
                                  "prim": "big_map",
                                  "args": [
                                    { "prim": "nat" },
                            ...
                            {
                              "prim": "pair",
                              "args": [ { "prim": "big_map", "args": [ { "prim": "nat" }, { "prim": "nat" } ] }, { "prim": "set", "args": [ { "prim": "address" } ] } ]
                            }
                          ]
                        }
                      ]
                  ...
                  [
                    {
                      ...
                      "args": [
                        [
                          ...
                          { "prim": "COMPARE" },
                          { "prim": "EQ" },
                          { "prim": "IF", "args": [ [], [ { "prim": "PUSH", "args": [ { "prim": "int" }, { "int": "676" } ] }, { "prim": "FAILWITH" } ] ] },
                          { "prim": "SWAP" },
                          { "prim": "DUP" },
                          { "prim": "GET", "args": [ { "int": "8" } ] },
                  ...
                  [
                    {
                      ...
                      "args": [
                        [
                          ...
                          { "prim": "SENDER" },
                          { "prim": "MEM" },
                          { "prim": "IF", "args": [ [], [ { "prim": "PUSH", "args": [ { "prim": "int" }, { "int": "581" } ] }, { "prim": "FAILWITH" } ] ] },
                          { "prim": "SWAP" },
                          { "prim": "DUP" },
                          { "prim": "DUG", "args": [ { "int": "2" } ] },
                          { "prim": "UNPAIR" },
                          ...
                          { "prim": "MEM" },
                          {
                            "prim": "IF",
                            "args": [
                              [ { "prim": "PUSH", "args": [ { "prim": "string" }, { "string": "NFT-asset: cannot mint token with existing hash" } ] }, { "prim": "FAILWITH" } ],
                              []
                            ]
                          },
                          { "prim": "SWAP" },
                          ...
                          { "prim": "NEQ" },
                          {
                            ...
                            "args": [
                              [
                                { "prim": "DUP" },
                                { "prim": "GET", "args": [ { "int": "5" } ] },
                                { "prim": "CONTRACT", "args": [ { "prim": "pair", "args": [ { "prim": "nat" }, { "prim": "string" } ] } ], "annots": [ "%updateTokenId" ] },
                                { "prim": "IF_NONE", "args": [ [ { "prim": "PUSH", "args": [ { "prim": "int" }, { "int": "613" } ] }, { "prim": "FAILWITH" } ], [] ] },
                                { "prim": "NIL", "args": [ { "prim": "operation" } ] },
                                { "prim": "SWAP" },
                                { "prim": "PUSH", "args": [ { "prim": "mutez" }, { "int": "0" } ] },
                                { "prim": "DUP", "args": [ { "int": "4" } ] },
                                      ...
                                      { "prim": "LT" },
                                      {
                                        ...
                                        "args": [
                                          [
                                            ...
                                            { "prim": "PAIR" },
                                            { "prim": "GET" },
                                            { "prim": "IF_NONE", "args": [ [ { "prim": "PUSH", "args": [ { "prim": "int" }, { "int": "444" } ] }, { "prim": "FAILWITH" } ], [] ] },
                                            { "prim": "COMPARE" },
                                            { "prim": "GE" },
                                            {
                                              "prim": "IF",
                                            ...
                                            {
                                              "prim": "IF_NONE",
                                              "args": [ [ { "prim": "PUSH", "args": [ { "prim": "int" }, { "int": "448" } ] }, { "prim": "FAILWITH" } ], [ { "prim": "DROP" } ] ]
                                            },
                                            { "prim": "DUP", "args": [ { "int": "6" } ] },
                                            { "prim": "GET", "args": [ { "int": "4" } ] },
                                            { "prim": "DIG", "args": [ { "int": "9" } ] },
                                            ...
                                            { "prim": "PAIR" },
                                            { "prim": "GET" },
                                            { "prim": "IF_NONE", "args": [ [ { "prim": "PUSH", "args": [ { "prim": "int" }, { "int": "448" } ] }, { "prim": "FAILWITH" } ], [] ] },
                                            { "prim": "SUB" },
                                            { "prim": "ISNAT" },
                                            { "prim": "IF_NONE", "args": [ [ { "prim": "PUSH", "args": [ { "prim": "int" }, { "int": "448" } ] }, { "prim": "FAILWITH" } ], [] ] },
                                            { "prim": "SOME" },
                                            ...
                                            { "prim": "MEM" },
                                            {
                                              ...
                                              "args": [
                                                [
                                                  ...
                                                  {
                                                    "prim": "IF_NONE",
                                                    "args": [ [ { "prim": "PUSH", "args": [ { "prim": "int" }, { "int": "451" } ] }, { "prim": "FAILWITH" } ], [] ]
                                                  },
                                                  { "prim": "DIG", "args": [ { "int": "6" } ] },
                                                  { "prim": "GET", "args": [ { "int": "4" } ] },
                                                  { "prim": "ADD" },
                        ...
                        [
                          {
                            ...
                            "args": [
                              [
                                ...
                                { "prim": "SENDER" },
                                { "prim": "MEM" },
                                { "prim": "IF", "args": [ [], [ { "prim": "PUSH", "args": [ { "prim": "int" }, { "int": "624" } ] }, { "prim": "FAILWITH" } ] ] },
                                { "prim": "SWAP" },
                                { "prim": "DUP" },
                                { "prim": "DUG", "args": [ { "int": "2" } ] },
                                { "prim": "CAR" },
                                ...
                                { "prim": "MEM" },
                                {
                                  ...
                                  "args": [
                                    [
                                      { "prim": "PUSH", "args": [ { "prim": "string" }, { "string": "NFT-asset: cannot update token with already existing hash" } ] },
                                      { "prim": "FAILWITH" }
                                    ],
                                    []
                                  ]
                                        ...
                                        "args": [
                                          [
                                            ...
                                            },
                                            {
                                              ...
                                              "args": [
                                                [],
                                                [ { "prim": "PUSH", "args": [ { "prim": "string" }, { "string": "FA2_NOT_ADMIN_OR_OPERATOR" } ] }, { "prim": "FAILWITH" } ]
                                              ]
                                            },
                                            { "prim": "DIG", "args": [ { "int": "2" } ] },
                                            { "prim": "UNPAIR" },
